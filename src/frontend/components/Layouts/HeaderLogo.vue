  ...
  <div v-bind:class="$style.logo">
    <svg
      ...
      <g
        data-v-0dd9719b=""
        fill="#ffffff"
        transform="translate(105.58499908447266,76.5471801788919)"
        class="icon-text-wrapper icon-svg-group iconsvg">
        <g transform="translate(34.415000915527344,0)" class="iconsvg-imagesvg">
          <g>
            <rect
              fill="#ffffff"
              fill-opacity="0"
              ...
              y="0"
              width="60"
              height="60.04563468235859"
              class="image-rect" /> <svg
                x="0"
                y="0"
                width="60"
                height="60.04563468235859"
                filtersec="colorsb2186373531"
                class="image-svg-svg primary"
                style="overflow: visible;"><svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0.0186874121427536 0.03168483451008797 71.8552474975586 71.91011047363281">
                  <path
